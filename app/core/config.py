...
class Settings(BaseSettings):
    ...
    # Custom reaction emojis and stickers live in
    # `<assets_root>/{reactions,stickers}/{standard,nsfw}/*.png` — a host bind-mount kept out of
    # git and out of `media_root` (see asset_pack_service).
    ...
    # Klipy GIF API (https://klipy.com) — server-side only, so it never ships inside the APK.
    klipy_api_key: str = ""
